...
class App:
    def __init__(self):
        pyxel.init(256, 128, title="07 Selection + Autres singes")
    ...
    def update(self):
        ...
        if self.jeu:
            if pyxel.btnp(pyxel.KEY_SPACE):
                if self.carte == "1":
                    ballon = definitions.Ballon(-17, 60, "Jaune")
                    self.liste_ballons.append(ballon)
                elif self.carte == "2":
                    ballon = definitions.Ballon(-17, 95, "Jaune")
                    self.liste_ballons.append(ballon)
                elif self.carte == "3":
                    ballon = definitions.Ballon(152, -17, "Jaune")
                    self.liste_ballons.append(ballon)
                elif self.carte == "4":
                    ballon = definitions.Ballon(-17, 60, "Jaune")
                    self.liste_ballons.append(ballon)
                ...
                if self.carte == "1":
                    ballon = definitions.Ballon(-17, 60, "Moab")
                    self.liste_ballons.append(ballon)
                elif self.carte == "2":
                    ballon = definitions.Ballon(-17, 95, "Moab")
                    self.liste_ballons.append(ballon)
                elif self.carte == "3":
                    ballon = definitions.Ballon(152, -17, "Moab")
                    self.liste_ballons.append(ballon)
                elif self.carte == "4":
                    ballon = definitions.Ballon(-17, 60, "Moab")
                    self.liste_ballons.append(ballon)
    ...
    def draw(self):
        ...
        if not self.jeu:
            if self.difficulte == "En attente":
                ...
                pyxel.text(105, 52, f"Round: ROUND", 0)
